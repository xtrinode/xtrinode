module github.com/xtrinode/xtrinode
...
require (
	...
	k8s.io/api v0.35.0 // replaced to v0.34.3 for KEDA 2.19.0
	k8s.io/apiextensions-apiserver v0.35.0 // replaced to v0.34.3 for KEDA 2.19.0
	k8s.io/apimachinery v0.35.0 // replaced to v0.34.3 for KEDA 2.19.0
	k8s.io/client-go v1.5.2 // replaced to v0.34.3 for KEDA 2.19.0
	sigs.k8s.io/controller-runtime v0.23.1 // replaced to v0.22.4 for KEDA 2.19.0
...
replace (
	// KEDA 2.19.0 pins its tested Kubernetes/controller-runtime line this way.
	// Dependency-module replaces do not propagate, so the main module repeats them.
