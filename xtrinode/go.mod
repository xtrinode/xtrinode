...
require (
	...
	k8s.io/api v0.36.0 // replaced to v0.34.3 for KEDA 2.19.0
	k8s.io/apiextensions-apiserver v0.36.0 // replaced to v0.34.3 for KEDA 2.19.0
	k8s.io/apimachinery v0.36.0 // replaced to v0.34.3 for KEDA 2.19.0
	k8s.io/client-go v1.5.2 // replaced to v0.34.3 for KEDA 2.19.0
	sigs.k8s.io/controller-runtime v0.23.3 // replaced to v0.22.4 for KEDA 2.19.0
