...
# Prerequisites: gcloud auth, gke-gcloud-auth-plugin (for kubectl), helm
#
# Install gke-gcloud-auth-plugin if needed:
#   sudo apt-get install google-cloud-sdk-gke-gcloud-auth-plugin
# Or: https://cloud.google.com/kubernetes-engine/docs/how-to/cluster-access-for-kubectl#install_plugin
